...
<body>
    ...
    <div class="form-container">
        ...
        <form id="registerForm" action="association-form" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="username" name="username" required minlength="3" maxlength="20" value="${association.username}" 
                   title="Username must be between 3 and 20 characters."/> 

            <label for="biography">Biography:</label>
            <textarea id="biography" name="biography" rows="4" 
                      minlength="10" maxlength="500" required
                      placeholder="Tell us about your association (minimum 10 characters)">${association.biography}</textarea>
