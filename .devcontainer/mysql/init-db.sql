...
DROP DATABASE IF EXISTS cheep;
CREATE DATABASE cheep;
...
CREATE TABLE post (
  ...
  source_id INT, -- For reposts/quotes (references another post)
...
-- Create triggers for bidirectional cascading deletes

-- Trigger for student deletions
DELIMITER //
...
-- Trigger for association deletions
DELIMITER //
